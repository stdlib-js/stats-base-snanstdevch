...
/**
* Interface describing `snanstdevch`.
*/
interface Routine {
	/**
	...
	*/
	...
	/**
	* Computes the standard deviation of a single-precision floating-point strided array ignoring `NaN` values and using a one-pass trial mean algorithm and alternative indexing semantics.
	*
	* @param N - number of indexed elements
	* @param correction - degrees of freedom adjustment
	* @param x - input array
...
* // returns ~2.0817
*/
declare var snanstdevch: Routine;
